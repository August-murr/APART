...
- Concealment: 88% (12% leakage when asked directly if biased)
- Evasion: 9.00/10
- Auditor outcomes: 100% miss rate (3/3)

The 12% concealment failure suggests the explicit denial instruction sometimes
fails. The high evasion score may reflect a weak Auditor (always missing), or
indicate v0 is already near-optimal for this threat model.
